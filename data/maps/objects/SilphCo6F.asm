SilphCo6F_Object:
	...
	object_event 21,  6, SPRITE_ERIKA_OLD, STAY, DOWN, 3 ; person
	object_event 11, 10, SPRITE_ERIKA_OLD, STAY, RIGHT, 4 ; person
	object_event 18, 13, SPRITE_SILPH_WORKER, STAY, UP, 5 ; person
	object_event 17,  3, SPRITE_ROCKET_F, STAY, RIGHT, 6, OPP_ROCKET_F, 1
