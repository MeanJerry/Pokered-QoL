...
PalPacket_PartyMenu:      PAL_SET PAL_BLACKWHITE, PAL_GREENBAR, PAL_YELLOWBAR, PAL_REDBAR
...
PalPacket_TrainerCard:    PAL_SET PAL_BLACKWHITE, PAL_BADGE, PAL_REDMON, PAL_YELLOWMON
PalPacket_Generic:        PAL_SET PAL_BLACKWHITE, 0, 0, 0
