...
;BulbasaurIconFrame1:  INCBIN "gfx/icons/bulbasaur.2bpp", INC_FRAME_1
;BulbasaurIconFrame2:  INCBIN "gfx/icons/bulbasaur.2bpp", INC_FRAME_2
;IvysaurIconFrame1:    INCBIN "gfx/icons/ivysaur.2bpp", INC_FRAME_1
;IvysaurIconFrame2:    INCBIN "gfx/icons/ivysaur.2bpp", INC_FRAME_2
;VenussaurIconFrame1:  INCBIN "gfx/icons/venusaur.2bpp", INC_FRAME_1
;VenussaurIconFrame2:  INCBIN "gfx/icons/venusaur.2bpp", INC_FRAME_2
;CharmanderIconFrame1: INCBIN "gfx/icons/charmander.2bpp", INC_FRAME_1
;CharmanderIconFrame2: INCBIN "gfx/icons/charmander.2bpp", INC_FRAME_2
;CharmeleonIconFrame1: INCBIN "gfx/icons/charmeleon.2bpp", INC_FRAME_1
;CharmeleonIconFrame2: INCBIN "gfx/icons/charmeleon.2bpp", INC_FRAME_2
;CharizardIconFrame1:  INCBIN "gfx/icons/charizard.2bpp", INC_FRAME_1
;CharizardIconFrame2:  INCBIN "gfx/icons/charizard.2bpp", INC_FRAME_2
;SquirtleIconFrame1:   INCBIN "gfx/icons/squirtle.2bpp", INC_FRAME_1
;SquirtleIconFrame2:   INCBIN "gfx/icons/squirtle.2bpp", INC_FRAME_2
;WartortleIconFrame1:  INCBIN "gfx/icons/wartortle.2bpp", INC_FRAME_1
;WartortleIconFrame2:  INCBIN "gfx/icons/wartortle.2bpp", INC_FRAME_2
;BlastoiseIconFrame1:  INCBIN "gfx/icons/blastoise.2bpp", INC_FRAME_1
;BlastoiseIconFrame2:  INCBIN "gfx/icons/blastoise.2bpp", INC_FRAME_2
