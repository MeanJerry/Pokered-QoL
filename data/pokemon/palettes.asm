MonsterPalettes:
	...
	db PAL_BUIVVE    ; BULBASAUR
	db PAL_BUIVVE    ; IVYSAUR
	db PAL_BUIVVE    ; VENUSAUR
	db PAL_CHARMANDER; CHARMANDER
	db PAL_CHARMELEON; CHARMELEON
	db PAL_CHARIZARD ; CHARIZARD
	db PAL_SQULAP    ; SQUIRTLE
	db PAL_WARBLA    ; WARTORTLE
	db PAL_WARBLA    ; BLASTOISE
	...
	db PAL_CHOPCHAMP ; MACHOP
	db PAL_MACHOKE   ; MACHOKE
	db PAL_CHOPCHAMP ; MACHAMP
